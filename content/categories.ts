...
export const CATEGORIES: Category[] = [
  ...
  {
    id: 'vest',
    name: { nb: 'Vest', sv: 'Väst' },
    scene: 'vest',
    gradient: ['#FF7A3D', '#2B5CE6'],
  },
  {
    id: 'jens',
    name: { nb: 'Jens Evensen', sv: 'Jens Evensen' },
    scene: 'jens',
    gradient: ['#0E4B7A', '#FF2D8E'],
  },
  {
    id: 'sjomat',
    name: { nb: 'Sjømat', sv: 'Fisk och skaldjur' },
    scene: 'sjomat',
    gradient: ['#0B7A79', '#FF2D8E'],
  },
  {
    id: 'hinton',
    name: { nb: 'Geoffrey Hinton', sv: 'Geoffrey Hinton' },
    scene: 'hinton',
  ...
  {
    id: 'goteborg',
    name: { nb: 'Göteborg', sv: 'Göteborg' },
    scene: 'goteborg',
    gradient: ['#0E6E8C', '#FF2D8E'],
  },
  {
    id: 'valley',
    name: { nb: 'Silicon Valley', sv: 'Silicon Valley' },
    scene: 'valley',
    gradient: ['#0E5A46', '#FF2D8E'],
  },
  {
    id: 'torden',
    name: { nb: 'Torden', sv: 'Åska' },
    scene: 'torden',
    gradient: ['#3A2E5C', '#FF2D8E'],
  },
]
